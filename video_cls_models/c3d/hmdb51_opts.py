...
def parse_opts():
    ...
    parser.add_argument(
        '--pretrain_path', default='/home/jingjing/zhipeng/adv-attack-video/data/pretrain-model/resnext-101-kinetics-hmdb51_split1.pth', type=str, help='Pretrained model (.pth)')
