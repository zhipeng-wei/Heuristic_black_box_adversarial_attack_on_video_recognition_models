...
def generate_model_c3d(dataset):
    ...
    if dataset == 'hmdb51':
        with open('/home/jingjing/zhipeng/adv-attack-video/code2/video_cls_models/c3d/hmdb51_params.pkl', 'rb') as ipt:
            model_opt = pickle.load(ipt)
        model_opt = DictToAttr(model_opt)
    elif dataset == 'ucf101':
        with open('/home/jingjing/zhipeng/adv-attack-video/code2/video_cls_models/c3d/ucf101_params.pkl', 'rb') as ipt:
            model_opt = pickle.load(ipt)
        model_opt = DictToAttr(model_opt)
